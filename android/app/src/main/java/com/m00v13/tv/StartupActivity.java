...
public final class StartupActivity extends Activity {
    ...
    private void launch(){if(isFinishing())return;Intent i=new Intent(this,MediaHubActivity.class);i.putExtra(MediaHubActivity.EXTRA_MODE,MediaHubActivity.MODE_HOME);i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);startActivity(i);finish();overridePendingTransition(0,0);}
}

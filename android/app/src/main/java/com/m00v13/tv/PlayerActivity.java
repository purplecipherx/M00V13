...
public final class PlayerActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state){
        ...
        boolean passthrough=new AppSettingsStore(this).automaticPassthrough();
        player=new ExoPlayer.Builder(this,new M00v13RenderersFactory(this,passthrough)).setSeekBackIncrementMs(10000L).setSeekForwardIncrementMs(30000L).build();view.setPlayer(player);

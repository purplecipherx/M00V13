...
public final class NativeProviderDefinition {
    public final String id,name,responseType,searchPath,queryParam,rowSelector,titleSelector,detailsSelector,detailsAttribute,seedersSelector,sizeSelector,rowMagnetSelector,detailMagnetSelector;
    ...
    public NativeProviderDefinition(String id,String name,List<String> mirrors,String responseType,String searchPath,String queryParam,String rowSelector,String titleSelector,String detailsSelector,String detailsAttribute,String seedersSelector,String sizeSelector,String rowMagnetSelector,String detailMagnetSelector,String jsonRowsPath,String jsonExpandArrayPath,String jsonTitlePath,String jsonSeedersPath,String jsonSizePath,String jsonInfoHashPath,String jsonQualityPath,String jsonCodecPath,String jsonAudioPath,String jsonUrlPath,int maxResults){
        ...
        this.responseType=empty(responseType)?"html":responseType; this.searchPath=nz(searchPath); this.queryParam=nz(queryParam);
        this.rowSelector=nz(rowSelector); this.titleSelector=nz(titleSelector); this.detailsSelector=empty(detailsSelector)?this.titleSelector:detailsSelector; this.detailsAttribute=empty(detailsAttribute)?"href":detailsAttribute;

...
public final class NativeProviderDefinition {
    ...
    public NativeProviderDefinition(String id,String name,List<String> mirrors,String responseType,String searchPath,String queryParam,String queryString,String rowSelector,String titleSelector,String titleAttribute,String detailsSelector,String detailsAttribute,String seedersSelector,String sizeSelector,String rowMagnetSelector,String detailMagnetSelector,String rowInfoHashSelector,String rowInfoHashAttribute,String detailInfoHashSelector,String jsonRowsPath,String jsonExpandArrayPath,String jsonTitlePath,String jsonSeedersPath,String jsonSizePath,String jsonInfoHashPath,String jsonQualityPath,String jsonCodecPath,String jsonAudioPath,String jsonUrlPath,int maxResults,int tier){
    ...
    public static List<NativeProviderDefinition> load(Context context,int wantedTier){
        ...
        try(InputStream in=context.getAssets().open("cardigann_providers.json")){
            ...
            if(providers!=null)for(int i=0;i<providers.length();i++){
                ...
                boolean validHtml=!d.isJson()&&!d.rowSelector.isEmpty()&&!d.titleSelector.isEmpty()&&(hasDirect||hasDetail);
